...
ar.push("Satsuki Kiryūin -Kill la Kill-");
ar.push("Ryūko Matoi -Kill la Kill-");
...
ar.push("Shannon 'Sayo' -Umineko no Naku Koro ni-");
...
ar.push("Moeka Kiryū -Steins;Gate-");
...
ar.push("Cécile Croomy -Code Geass-");
...
ar.push("Emi 'Emilia Justina' Yusa -The Devil is a Part-Timer!-");
ar.push("Emeralda Etuva -The Devil is a Part-Timer!-");
ar.push("Suzuno 'Crestia Bell' Kamazuki -The Devil is a Part-Timer!-");
ar.push("Mihoshi 'Kirara' -Gundam Build Fighters-");
...
ar.push("Ayame Kajou -Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn’t Exist-");
ar.push("Otome Saotome -Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn’t Exist-");
ar.push("Kosuri Onigashira -Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn’t Exist-");
ar.push("Anna Nishikinomiya -Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn’t Exist-");
ar.push("Hyouka Fuwa -Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn’t Exist-");
ar.push("Oboro Tsukimigusa -Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn’t Exist-");
...
ar.push("ominica Skoda -Hitsugi no Chaika-");
